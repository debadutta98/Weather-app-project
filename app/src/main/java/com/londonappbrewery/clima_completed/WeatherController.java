...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "d4010c0c8ee40389970914943892c9d6";
...
//        letsDoSomeNetworking(params);
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                com.debadutta.wingy.WeatherDataModel weatherData = com.debadutta.wingy.WeatherDataModel.fromJson(response);
    ...
    private void updateUI(com.debadutta.wingy.WeatherDataModel weather) {
